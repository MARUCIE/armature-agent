...
[![Tests](https://img.shields.io/badge/Tests-1598%20passing-brightgreen.svg)](#sota-agent-capabilities)
...
Tested: 1598 automated tests, fast gate `63/63`, nightly gate `66/66`, release gate `69/69`.
...
┌─────────────────────────────────────────────────────┐
│  Orca CLI  v0.8.3                                   │
│  TypeScript ESM CLI · 86 test files · 1598 tests    │
├─────────────────────────────────────────────────────┤
│  Command Layer                                      │
