...
[![Tests](https://img.shields.io/badge/Tests-1615%20passing-brightgreen.svg)](#sota-agent-capabilities)
...
Tested: 1615 automated tests, fast gate `63/63`, nightly gate `66/66`, release gate `69/69`.
...
┌─────────────────────────────────────────────────────┐
│  Orca CLI  v0.8.13                                  │
│  TypeScript ESM CLI · 88 test files · 1615 tests    │
├─────────────────────────────────────────────────────┤
│  Command Layer                                      │
